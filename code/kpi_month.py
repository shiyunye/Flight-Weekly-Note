...
def calculate_business_metrics(df_priceline, start_date, end_date, pp_start_date, pp_end_date):
    ...
    df_total = calculate_metrics(
        df_priceline, start_date, end_date, pp_start_date, pp_end_date,
        group_col="company", suffix="_total"
    )
...
def calculate_carrier_metrics(df_priceline_b2c_standalone, start_date, end_date, pp_start_date, pp_end_date):
    df_retail = calculate_metrics(
        df_priceline_b2c_standalone, start_date, end_date, pp_start_date, pp_end_date,
...
def calculate_channel_metrics(df_priceline_b2c_standalone, start_date, end_date, pp_start_date, pp_end_date):
...
def calculate_source_metrics(df_priceline_b2c_standalone, start_date, end_date, pp_start_date, pp_end_date):
...
def calculate_brand_metrics(df_weekly, start_date, end_date, pp_start_date, pp_end_date):
    df_us_origin = calculate_metrics(
        df_weekly, start_date, end_date, pp_start_date, pp_end_date,
