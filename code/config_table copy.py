...
def create_others_table(word_document,df_others):
    ...
    icons_and_labels_col1 = [
        ('../Screenshots/weeklynote/Market Share.png', 'Market Share', 2, 7),
        ('../Screenshots/weeklynote/Parity.png', 'Parity', 8,10),
        ('../Screenshots/weeklynote/Share of Business.png', 'Share of Business', 11, 14),
         ('../Screenshots/weeklynote/Product.png', 'Product', 15, 19),
    ]
    ...
    icons_and_labels_col2 = [
        ...
        ('../Screenshots/weeklynote/Bookability.png', 'Upsell', 17, 17, 0.4, 0.4),
        ('../Screenshots/weeklynote/booking_rate.png', 'Booking rate', 18, 18, 0.4, 0.4),
         ('../Screenshots/weeklynote/ticket_order.png', 'Tickets/order', 19, 19, 0.4, 0.4)
    ...
    priceline_paragraph.add_run().add_picture(
        '../Screenshots/weeklynote/priceline.png',
        width=Inches(0.48),
        height=Inches(0.21)
    )
    ...
    agoda_paragraph.add_run().add_picture(
        '../Screenshots/weeklynote/agoda.png',
        width=Inches(0.5),
        height=Inches(0.26)
    )
    ...
    bcom_paragraph.add_run().add_picture(
        '../Screenshots/weeklynote/B.com.png',
        width=Inches(0.5),
        height=Inches(0.08)
    )
    ...
    bhi_paragraph.add_run().add_picture(
        '../Screenshots/weeklynote/BHI.png',
        width=Inches(0.5),
        height=Inches(0.21)
    )
...
def create_roi_table(word_document, df):
    ...
    icons_and_labels_col1 = [
        ...
        ('../Screenshots/weeklynote/Shop PPC.png',       'Shop PPC',      5, 9),
    ]
    for icon_path, label, start_row, end_row in icons_and_labels_col1:
