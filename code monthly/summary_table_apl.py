import pandas as pd
def create_ytd_ly(df_weekly,df_gds_incentive,end_date,begin_of_current_year,begin_of_last_year,ytd_last_year):
    df_gds_incentive_ytd=df_gds_incentive.loc[
                (df_gds_incentive['trans_date'] <= end_date)
                & (df_gds_incentive['trans_date'] >= begin_of_current_year)]['net_gds_incentives'].sum()
  
    df_gds_incentive_ytd_ly=df_gds_incentive.loc[
            (df_gds_incentive['trans_date'] <= ytd_last_year)
            & (df_gds_incentive['trans_date'] >= begin_of_last_year)]['net_gds_incentives'].sum()

    df_gds_incentive_ytd_cw=df_gds_incentive.loc[
            (df_gds_incentive['trans_date'] == end_date)]['net_gds_incentives'].sum()

    df_gds_incentive_ytd_cw_flightonly =df_gds_incentive.loc[
        (df_gds_incentive['trans_date'] == end_date)]['net_gds_incentives'].sum()

    total_priceline_ytd = (
        df_weekly.loc[
            (df_weekly['trans_date'] <= end_date)
            & (df_weekly['trans_date'] >= begin_of_current_year)
            ...
            'normalized_gross_tickets_cy','normalized_gross_tickets_ly','net_contr_fee_cy','net_contr_fee_ly','gr_contr_fee_cy','gr_contr_fee_ly','gr_wex_fee','net_wex_fee']]
        .sum()
        .to_frame()
        .T
    )
    ...
    total_priceline_ytd_flightonly = (
        df_weekly.loc[
            ...
            [['net_tkts_cy','net_tkts_ly','net_contr_fee_cy','net_contr_fee_ly','gr_contr_fee_cy','gr_contr_fee_ly','gr_wex_fee','net_wex_fee']]
        .sum()
        .to_frame()
        .T
    )
    ...
    total_priceline_ytd = total_priceline_ytd[
        ...
        ,'normalized_gross_tickets_ly', 'net_contr_fee_cy','net_contr_fee_ly','gr_contr_fee_cy','gr_contr_fee_ly','gr_wex_fee','net_wex_fee']
    ]
    ...
    total_priceline_ytd['ytd_netconrfee'] = (
        (total_priceline_ytd['net_contr_fee_cy'].fillna(0)+df_gds_incentive_ytd+total_priceline_ytd['gr_wex_fee'].fillna(0)) / (total_priceline_ytd['net_contr_fee_ly'].replace(0, pd.NA)+df_gds_incentive_ytd_ly+total_priceline_ytd_ly['gr_wex_fee'].fillna(0))
    ) - 1

    total_priceline_ytd['ytd_grconrfee'] = (
        (total_priceline_ytd['gr_contr_fee_cy'].fillna(0)+df_gds_incentive_ytd+total_priceline_ytd['gr_wex_fee'].fillna(0)) / (total_priceline_ytd['gr_contr_fee_ly'].replace(0, pd.NA)+df_gds_incentive_ytd_ly+total_priceline_ytd_ly['gr_wex_fee'].fillna(0))
    ) - 1

    total_priceline_ytd['ytd_netconrfee_flightonly'] = (
        (total_priceline_ytd_flightonly['net_contr_fee_cy'].fillna(0)+df_gds_incentive_ytd+total_priceline_ytd['net_wex_fee'].fillna(0)) / (total_priceline_ytd_flightonly['net_contr_fee_ly'].replace(0, pd.NA)+df_gds_incentive_ytd_ly+total_priceline_ytd_ly['gr_wex_fee'].fillna(0))
    ) - 1

    total_priceline_ytd['ytd_grconrfee_flightonly'] = (
        (total_priceline_ytd_flightonly['gr_contr_fee_cy'].fillna(0)+df_gds_incentive_ytd+total_priceline_ytd['gr_wex_fee'].fillna(0)) / (total_priceline_ytd_flightonly['gr_contr_fee_ly'].replace(0, pd.NA)+df_gds_incentive_ytd_ly+total_priceline_ytd_ly['gr_wex_fee'].fillna(0))
    ) - 1

    summary_data = [
    {
        'Measure': 'Net Tickets',
        'CW': total_priceline_cw['net_tkts_cy'].iloc[0],
    ...
    },
    {
        ...
        'CW': total_priceline_cw['gr_tkts_cy'].iloc[0],
    ...
    },
    {
        ...
        'CW': total_priceline_cw['net_contribution_cy'].iloc[0],
    ...
    },
    {
        ...
        'CW': total_priceline_cw['gross_contribution_cy'].iloc[0],
    ...
    },
    {
        ...
        'CW': total_priceline_cw['normalized_net_tickets_cy'].iloc[0],
    ...
    },
    {
        ...
        'CW': total_priceline_cw['normalized_gross_tickets_cy'].iloc[0],
    ...
    },
    {
        ...
        'CW': df_gds_incentive_ytd_cw,
        'CY': df_gds_incentive_ytd,
        'LY':df_gds_incentive_ytd_ly,
        # 'YTD': total_priceline_ytd['ytd_gds_incentive'].iloc[0]*100
    },
    {
        'Measure': 'Net Cont + Fee + Incentives',
        'CW': total_priceline_cw['net_contr_fee_cy'].iloc[0]+df_gds_incentive_ytd_cw,

        'CY': total_priceline_ytd['net_contr_fee_cy'].iloc[0]+df_gds_incentive_ytd
        ,
        'LY': total_priceline_ytd['net_contr_fee_ly'].iloc[0]+df_gds_incentive_ytd_ly
        ,
        'YTD': total_priceline_ytd['ytd_netconrfee'].iloc[0]*100
    },
    {
        'Measure': 'Gross Cont + Fee + Incentives',
        'CW': total_priceline_cw['gr_contr_fee_cy'].iloc[0]+df_gds_incentive_ytd_cw,

        'CY': total_priceline_ytd['gr_contr_fee_cy'].iloc[0]+df_gds_incentive_ytd
        ,
        'LY': total_priceline_ytd['gr_contr_fee_ly'].iloc[0]+df_gds_incentive_ytd_ly
        ,
        'YTD': total_priceline_ytd['ytd_grconrfee'].iloc[0]*100    
    },
    {
        ...
        'CW': total_priceline_cw['net_contr_fee_cy'].iloc[0]+df_gds_incentive_ytd_cw_flightonly,

        'CY': total_priceline_ytd_flightonly['net_contr_fee_cy'].iloc[0]+df_gds_incentive_ytd
        ,
        'LY': total_priceline_ytd_flightonly['net_contr_fee_ly'].iloc[0]+df_gds_incentive_ytd_ly
        ,
    ...
    },
    {
        ...
        'CW': total_priceline_cw['gr_contr_fee_cy'].iloc[0]+df_gds_incentive_ytd_cw_flightonly,

        'CY': total_priceline_ytd_flightonly['gr_contr_fee_cy'].iloc[0]+df_gds_incentive_ytd
        ,
        'LY': total_priceline_ytd_flightonly['gr_contr_fee_ly'].iloc[0]+df_gds_incentive_ytd_ly
        ,
    ...
    summary_table['CW'] = summary_table['CW'].round(0)
